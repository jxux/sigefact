    ...
    <div>
        ...
        <div class="card mb-0">
            <div class="card-header bg-info">
                <h3 class="my-0">Listado general de eventos </h3>
            </div>
            <div class="card-body">
                <data-table :resource="resource" class="table-sm table-hover">
                    ...
                    <tr slot-scope="{ row }" >
                        ...
                        <td>{{ row.end_time }}</td>
                        <td>{{ row.hour }}</td>
                        <td class="d-inline-block text-truncate" style="max-width: 180px;">{{ row.client }}</td>
                        <td>{{ row.category }}</td>
                        <td>{{ row.service}}</td>
                        <td>{{ row.period }}</td>
                        <td class="d-inline-block text-truncate" style="max-width: 150px;">{{ row.description }}</td>
                        <td>
